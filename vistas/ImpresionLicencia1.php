...
//instrucion que inserta la libreria pare insertar el QR
...
$pdf->addText(187,316,14, ' <b>'. $participante2->getNLicenciaGDE(). '</b>                                <b>' . $nExpediente . '</b>                                 <b>' . $participante2->getNResolGDE(). '</b>                <b>' . $dtllTRR .'</b>', 0, array('justification'=>'left'));
$pdf->addText(180,198,14, ' <b>'.utf8_encode($participante->getNonRazonSocial()). '</b>');
$pdf->addText(180,176,14, ' <b>'. mb_strtoupper($direEst). '</b>');
...
$pdf->addText(180,135,14, ' <b>'.mb_strtoupper($participante->getActividadEconomica()). '</b>');
